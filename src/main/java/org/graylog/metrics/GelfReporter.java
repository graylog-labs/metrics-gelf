...
public class GelfReporter extends ScheduledReporter {
    ...
    public static class Builder {
        ...
        /**
         * Allows to configure a special {@link MetricFilter}, which defines what metrics are reported
         */
        ...
        public GelfReporter build() throws IOException {
    ...
    private void sendTimer(long timestamp, String name, Timer timer) {
        ...
        final GelfMessageBuilder message = new GelfMessageBuilder("name=" + name + " type=TIMER", source)
                ...
                .additionalField("mean_rate", timer.getMeanRate())
                .additionalField("m1", timer.getOneMinuteRate())
                .additionalField("m5", timer.getFiveMinuteRate())
                .additionalField("m15", timer.getFifteenMinuteRate())
    ...
    private void sendMeter(long timestamp, String name, Meter meter) {
        final GelfMessageBuilder message = new GelfMessageBuilder("name=" + name + " type=METER", source)
                ...
                .additionalField("mean_rate", meter.getMeanRate())
                .additionalField("m1", meter.getOneMinuteRate())
                .additionalField("m5", meter.getFiveMinuteRate())
                .additionalField("m15", meter.getFifteenMinuteRate())
                .additionalField("rate_unit", getRateUnit());
